          ...
          <div className="space-y-8">
            ...
            <div className="bg-netflix-dark-gray p-6 rounded-lg">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a href="https://wa.me/5561982599983"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center h-12 w-12 rounded-full bg-netflix-medium-gray text-white hover:bg-netflix-red transition-colors"
                  aria-label="WhatsApp"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" className="w-8 h-8">
                    <path d="M16 3.04c-7.168 0-13 5.832-13 13 0 2.292.6 4.522 1.74 6.5l-1.845 6.74 6.912-1.812A12.926 12.926 0 0 0 16 29.04c7.168 0 13-5.832 13-13s-5.832-13-13-13zm0 23.4a10.35 10.35 0 0 1-5.278-1.464l-.378-.226-4.108 1.077 1.096-4.005-.246-.41a10.31 10.31 0 0 1-1.566-5.372c0-5.71 4.646-10.356 10.356-10.356s10.356 4.646 10.356 10.356S21.71 26.44 16 26.44zm5.922-7.487c-.258.73-1.49 1.418-2.036 1.51-.546.093-1.256.133-2.032-.126-.468-.15-1.08-.35-1.86-.684-3.277-1.413-5.41-4.72-5.574-4.944-.164-.225-1.332-1.776-1.332-3.39 0-1.613.844-2.406 1.144-2.736.3-.33.656-.412.874-.412.218 0 .437.003.63.011.203.01.486-.078.763.58.258.63.877 2.18.954 2.335.077.155.129.337.014.562-.112.225-.168.362-.33.556-.164.195-.349.437-.498.587-.164.164-.335.344-.143.67.194.33.866 1.43 1.857 2.316 1.276 1.136 2.35 1.49 2.68 1.654.33.164.52.146.714-.087.194-.232.823-.96 1.042-1.287.218-.33.437-.275.73-.164.3.112 1.903.897 2.228 1.059.33.164.546.248.63.388.082.146.082.84-.176 1.57z" />
                  </svg>
                </a>
