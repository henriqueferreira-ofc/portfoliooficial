...
const ProjectCard = ({ imageUrl, title, description, tags, link }: ProjectCardProps) => {
  ...
  return (
    <>
      <div
        className="group relative w-full h-[180px] md:h-[210px] overflow-hidden rounded-lg cursor-pointer shadow-lg transition-all duration-500 ease-out hover:scale-[1.04] hover:shadow-[0_20px_50px_-12px_rgba(229,9,20,0.55)] hover:z-10"
      ...
      >
        ...
        <div className="absolute inset-0 p-4 flex flex-col justify-end">
          <h3 className="font-bold text-base md:text-lg text-white drop-shadow-lg translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
            {title}
          </h3>
          <div className="flex flex-wrap gap-1.5 mt-2 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-500">
